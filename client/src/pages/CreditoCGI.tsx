    ...
    <div className="container mx-auto p-6 max-w-7xl">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Sistema de simulação e contratação de crédito com garantia imobiliária
            </p>
          </div>
        </div>
      </div>
      ...
      <Card className="bg-card dark:bg-card border border-border dark:border-border">
        <CardContent className="p-12 text-center">
          <div className="flex items-center justify-center w-20 h-20 bg-emerald-100 dark:bg-emerald-900/30 rounded-full mx-auto mb-6">
            <Clock className="w-10 h-10 text-emerald-600 dark:text-emerald-400 animate-pulse" />
          </div>
