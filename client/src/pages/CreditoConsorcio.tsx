    ...
    <div className="min-h-screen w-full p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <Card className="bg-red-500 text-white border-0">
            <CardContent className="p-4 sm:p-6 text-center">
              <p className="text-red-100 text-xs sm:text-sm mb-1 sm:mb-2">Propostas enviadas</p>
              ...
              <div className="flex-1">
                <div className="flex flex-wrap items-center gap-2 mb-3 sm:mb-4">
                  ...
                  <div className="flex gap-1">
                    ...
                    <div className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-red-700 rounded-sm"></div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div className="space-y-1 sm:space-y-2">
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 flex items-center gap-1">
                      Cotas Enviadas <HelpCircle className="h-3 w-3" />
                    </p>
                  ...
                  <div className="space-y-1 sm:space-y-2">
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 flex items-center gap-1">
                      Taxa de Conversão <HelpCircle className="h-3 w-3" />
                    </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div className="flex flex-col xs:flex-row xs:items-center justify-between gap-2 xs:gap-0">
          <h2 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100">Últimas cotas de consórcio</h2>
